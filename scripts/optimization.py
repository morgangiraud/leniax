...
def run(omegaConf: DictConfig) -> None:
    ...
    update_fn = leniax_core.build_update_fn(K.shape, mapping, 'v1', True, True)
    ...
    lr = 5e-2
    for i in range(200):
        error, (K_grad, gfnparams_grad) = update_fn_gfngrad(inputs, K, gfn_params, kernels_weight_per_channel, dt, target)
